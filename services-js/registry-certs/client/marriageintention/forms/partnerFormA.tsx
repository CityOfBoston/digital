...
export default class PartnerForm extends Component<Props> {
  ...
  public static isComplete({
    ...
    //     partnerA_birthState.length > 0 && partnerA_birthZip.length > 0
    //       ? true
    //       : false;
    // }
      ...
      <div css={SECTION_WRAPPER_STYLING}>
        ...
        >
          ...
          {/* <TextInput
            ...
            name="partnerA_birthHospital"
            value={partnerA_birthHospital}
            onChange={this.handleChange}
            disableLabelNoWrap={true}
            optionalDescription={
    ...
    return (
      <div css={SECTION_WRAPPER_STYLING}>
        ...
        {/* <TextInput
          ...
          name="partnerA_birthZip"
          value={partnerA_birthZip}
          onChange={this.handleChange}
          disableLabelNoWrap={true}
          type={'number'}
        /> */}
