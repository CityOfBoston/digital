        ...
        <div className="b-c">
          ...
          <div css={RECEIPT_CSS}>
            ...
            <div className={'body'}>
              ...
              <p>
                We will mail out your order in 1–2 business days via the U.S.
                Postal Service.
              </p>
              ...
              <p>
                ...
                <Link href="mailto:birth@boston.gov">birth@boston.gov</Link>.
              </p>
...
const RECEIPT_CSS = css`
  .banner {
    display: flex;
    color: ${CHARLES_BLUE};
    padding: 24px 32px 10px;
    background: rgba(0, 136, 23, 0.25);
    border: 1px dotted #008817;
