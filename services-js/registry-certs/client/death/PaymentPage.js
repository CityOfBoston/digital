...
@observer
export class PaymentPageContent extends React.Component<ContentProps> {
              ...
              <button className="sel-c sel-c--fw" type="button">
                <div className="sel-f">
                  ...
                  <div className="t--info">
                    {cart.size}{' '}
                    {cart.size === 1 ? 'certificate' : 'certificates'} × ${CERTIFICATE_COST}{' '}
...
export const wrapPaymentPageControrrel = (
  ...
  class CertificatePageController extends React.Component<{}> {
    ...
    render() {
      ...
      return renderContent({ cart, submit });
    }
  };

export default wrapPaymentPageControrrel(
  getDependencies,
  (props: ContentProps) => <PaymentPageContent {...props} />
);
