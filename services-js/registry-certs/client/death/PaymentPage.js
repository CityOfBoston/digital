...
export const wrapPaymentPageController = (
  ...
  class CertificatePageController extends React.Component<{}> {
    ...
    render() {
      ...
      return renderContent(this.dependencies, { cart, submit });
    }
  };

export default wrapPaymentPageController(
  getDependencies,
  wrapAppLayout('lookup', (_, props) => <PaymentPageContent {...props} />)
);
