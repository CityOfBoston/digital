...
import MarriageIntentionCertificateRequest from './MarriageIntentionCertificateRequest';
...
describe('clone', () => {
  ...
  it('makes a new request that changes independently', () => {
    const original = new MarriageIntentionCertificateRequest();
...
describe('updateFrom', () => {
  it('copies answers over', () => {
    ...
    const updated = new MarriageIntentionCertificateRequest();
...
describe('serialization', () => {
  let req: MarriageIntentionCertificateRequest;

  beforeEach(() => {
    req = new MarriageIntentionCertificateRequest();
    req.quantity = 10;
...
`);
  ...
  it('round-trips back from JSON', () => {
    const newRequest = new MarriageIntentionCertificateRequest();
