...
import type { ReverseGeocodeQuery, ReverseGeocodeQueryVariables } from './graphql/types';
...
export default async function reverseGeocode(
  ...
  const response: ReverseGeocodeQuery = await loopbackGraphql(ReverseGeocodeGraphql, args);
