      ...
      <div className="mn mn--nv-s">
        ...
        <div className="b b--fw">
          <div className="b-c">
            ...
            <div className="g">
              <a href="https://twitter.com/bos311" className="lwi lwi--y g--3">
              ...
              <a href="tel:+311" className="lwi lwi--y g--3">
              ...
              <a href="https://www.boston.gov/departments/innovation-and-technology/apps#bos-311" className="lwi lwi--y g--3">
              ...
              <a href="/" className="lwi lwi--y g--3">
