        ...
        <div className={CONTENT_STYLE}>
          ...
          <form className={SEARCH_FORM_STYLE} onSubmit={this.whenSearchSubmit}>
            <input
              ...
              type="text"
            />
            <button type="submit" disabled={addressQuery.length === 0}>Search</button>
          </form>
          <button className={BUTTON_STYLE} disabled={!address} onClick={next}>Next</button>
        </div>
      </div>
    );
  }
