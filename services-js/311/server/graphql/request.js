...
export const resolvers = {
  Request: {
    ...
    requestedAtString: (r: Root, { format = '' }: DateStringArguments) => moment(r.requested_datetime).tz('America/New_York').format(format),
    updatedAtString: (r: Root, { format = '' }: DateStringArguments) => moment(r.updated_datetime).tz('America/New_York').format(format),
    requestedAtRelativeString: (r: Root) => moment(r.requested_datetime).fromNow(),
