    ...
    return (
      <html lang="en" className="js flexbox">
        <Head>
          ...
          {/* The public notices board doesn’t use Fleet. */}
          <link
            href="https://fonts.googleapis.com/css?family=Lora:400,400i,700,700i|Montserrat:400,700"
            rel="stylesheet"
          />
