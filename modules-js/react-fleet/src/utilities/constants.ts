...
// The original colors have been renamed as the LIGHT variants.

// LIGHT should always be used for text links on Charles Blue or black. It’s
// also the preferred variant for some elements’ hover background color, and can
// also be used in decorative cases.
//
...
export const FOCUS_INDICATOR_COLOR = OPTIMISTIC_BLUE_LIGHT;
export const ERROR_BORDER_COLOR = FREEDOM_RED_LIGHT;
export const ERROR_TEXT_COLOR = FREEDOM_RED_DARK;

export const LORA_SRC =
  'https://patterns.boston.gov/fonts/lora/lora-regular-webfont.woff2';
export const MONTSERRAT_SRC =
